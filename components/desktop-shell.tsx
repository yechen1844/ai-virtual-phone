...
import { startComplexMemoryScheduler, stopComplexMemoryScheduler } from "@/lib/complex-memory/scheduler";
...
import MovieApp from "@/components/movie/movie-app";
...
<script>setTimeout(function(){window.location.replace(${escapedTargetUrl});},80);</script>
  ...
  function renderAppBody() {
    ...
    if (activeApp === "movie") {
      return <MovieApp onClose={() => setActiveApp(null)} />;
    }
